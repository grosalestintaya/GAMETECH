...
?>
					...
					<!-- Agregar el nuevo botón de "Login Admin" -->
					<li><a href="admin"><i class="icon fa fa-lock"></i>Login Admin</a></li>
			...
			<div class="cnt-block">
				<ul class="list-unstyled list-inline">
					<li class="dropdown dropdown-small">
						<a href="order-history.php" class="dropdown-toggle" ><span class="key">Seguimiento de pedidos</span></a>
					</li>
				</ul>
			</div>
